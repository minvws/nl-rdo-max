...
class RedirectBaseException(Exception, abc.ABC):
    def __init__(
        self, *, error: str, error_description: str, redirect_uri: Union[str, None]
    ):
...
class InvalidClientException(TemplateBaseException):
    ...
    def __init__(self, *, error_description, redirect_uri: Union[str, None]):
        super().__init__(
...
class InvalidRedirectUriException(TemplateBaseException):
    def __init__(self, *, redirect_uri: Union[str, None]):
        super().__init__(
            error=UNAUTHORIZED_CLIENT,
...
class ServerErrorException(JsonBaseException):
    def __init__(self, *, error_description: str, redirect_uri: Union[str, None]):
        super().__init__(
            error=SERVER_ERROR,
            error_description=error_description,
            redirect_uri=redirect_uri,
...
class TooManyRequestsFromOrigin(JsonBaseException):
    def __init__(self, *, ip_expire_s: str, redirect_uri: Union[str, None]) -> None:
        super().__init__(
            error=TEMPORARILY_UNAVAILABLE,
...
class UnexpectedAuthnBinding(JsonBaseException):
    def __init__(
        self, *, error_description: str, redirect_uri: Union[str, None]
    ) -> None:
        super().__init__(
            error=SERVER_ERROR,
            error_description=error_description,
