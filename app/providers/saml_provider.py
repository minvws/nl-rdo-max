...
class SAMLProvider():
    ...
    def assertion_consumer_service(self, request: AssertionConsumerServiceRequest):
        ...
        pyop_authorize_response = self._pyop_provider.authorize(auth_req, "client") # TODO: Change this to client from clients.json, if possible
        ...
        # cache artifact under key code:
        # cache code challenge under key code:
