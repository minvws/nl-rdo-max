...
def test_login_digid():
    ...
    response = client.get(f"/login-digid?force_digid=1&state=%22%3E%3Cscript%3Ealert(%27XSS%27)%3C%2fscript%3E&idp_name=tvs&authorize_request={authn_str}")
...
def test_digid_mock():
    ...
    response = client.post(f"/digid-mock?state=638a16414ee8dfaadf1a4d64cc9d2fba7ddb29b5f6f5849f3f6f1cbec9b44a75&idp_name=tvs&authorize_request={authn_str}", data=form_data)
