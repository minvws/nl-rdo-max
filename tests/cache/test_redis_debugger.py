...
def test_redis_debugger_no_retrieve_with_redis_cache_hset(capture_logging, debuggable_redis_cache_fast_expire):
    # Set value but don't retrieve
    debuggable_redis_cache_fast_expire.hset("7f2fa9a48d8f4aef95a5fffb695d8f20", constants.RedisKeys.CC_CM.value, "test-value")
    time.sleep(2)
...
# pylint: disable=redefined-outer-name, unused-argument
def test_redis_debugger_retrieve_with_redis_cache_hget(capture_logging, debuggable_redis_cache_fast_expire):

    # Set value and retrieve:
    debuggable_redis_cache_fast_expire.hset("1a1bc9t25d2f4oly52i3pabc241d1f10", constants.RedisKeys.CC_CM.value, "test-value")
    debuggable_redis_cache_fast_expire.hget("1a1bc9t25d2f4oly52i3pabc241d1f10", constants.RedisKeys.CC_CM.value)
    time.sleep(2)
...
# pylint: disable=redefined-outer-name, unused-argument
def test_redis_debugger_no_retrieve_with_redis_cache_set(capture_logging, debuggable_redis_cache_fast_expire):
...
def test_redis_debugger_no_retrieve_with_redis_cache_get(capture_logging, debuggable_redis_cache_fast_expire):
    debuggable_redis_cache_fast_expire.set('test-key', 'true')
