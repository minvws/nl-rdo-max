...
def test_listen_for_expiration_events_when_not_retrieved(debuggable_redis_cache_fast_expire, redis_caplog, redis_mock):
...
def test_listen_for_expiration_events(debuggable_redis_cache_fast_expire, redis_caplog, redis_mock):
    redis_mock.set("debug_namespace:key", "value", ex=1)
