...
def test_idp_metadata_bindings_tvs(tvs_config):
    ...
    """
    idp_metadata = IdPMetadata('tests/resources/sample_messages/idp_metadata_authnpost.xml')
...
def test_idp_metadata_bindings_digid(digid_config):
    ...
    """
    idp_metadata = IdPMetadata('tests/resources/sample_messages/idp_metadata_authnredirect.xml')
...
def test_metadata_clustered(tvs_config, tvs_clustered_provider_settings, jinja_env):
    ...
    entity_descriptors = tvs_provider.sp_metadata.root.findall('.//md:EntityDescriptor', NAMESPACES)
    ...
    assert lc_entity_descriptor.find('.//AssertionConsumerService', NAMESPACES) == dv_entity_descriptor.find('.//AssertionConsumerService', NAMESPACES)
